...
const SchemaDiscordPresenceUser = yup
  .object({
...
const SchemaDiscordPresenceActivityAssets = yup
  .object({
    small_text: yup
      .string()
      .nullable()
...
const SchemaDiscordPresenceActivity = yup
  .object({
...
export const SchemaDiscordPresence = yup
  .object({
    spotify: yup
      .mixed()
      .nullable()
